...
function Navbar(){
    return(
        <nav className="h-[9%] w-[calc(100%-20px)] bg-white p-[4px] mt-[10px] ml-[10px] mr-[10px] flex justify-between items-center shadow-md rounded-[10px]">
            <h1 className="text-3xl font-bold ml-[20px]">Connectify</h1>
            <div className="flex justify-between gap-[15px] items-center px-[15px]">
                <div className="flex items-center bg-[#DFE1E5] border-2 border-gray-300 rounded-[20px] p-1 pl-3 ">
                ...
                <button className="bg-[#DFE1E5] p-2 rounded flex items-center gap-2 rounded-[30px] hover:bg-[#E4E6EB] transition duration-300 ease-in-out">
                    <img src={settings} alt="Icon" className="w-5 h-5" />
                </button>
                <button className="bg-[#DFE1E5] p-2 px-[10px] rounded flex items-center gap-2 rounded-[30px] hover:bg-[#E4E6EB] transition duration-300 ease-in-out">
